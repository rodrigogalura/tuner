...
class SortableFields extends Fields
{
    ...
    const ERR_MSG_DISABLED = 'Sortable fields are empty!';

    const ERR_CODE_PCOLS_VCOLS_NO_MATCH = 6;

    const ERR_MSG_PCOLS_VCOLS_NO_MATCH = 'Sortable fields are invalid. It must be at least one match in visible fields!';
