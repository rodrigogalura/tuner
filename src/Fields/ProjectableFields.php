 ...
 * @internal
 */
class ProjectableFields extends Fields
{
    const ERR_CODE_DISABLED = 1;

    const ERR_MSG_DISABLED = 'Projectable fields are empty!';

    const ERR_CODE_PCOLS_VCOLS_NO_MATCH = 2;

    const ERR_MSG_PCOLS_VCOLS_NO_MATCH = 'Projectable fields are invalid. It must be at least one match in visible fields!';
